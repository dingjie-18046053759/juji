...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	...
	    	function deleteData(pvtid){
	    		if (confirm("确定要删除该数据吗？")){
	    			$.ajax({
					     url : "<%=basePath%>backActivity/activityDel.do",
					     data : "aid="+pvtid,
					     async : false,
					     type : "post",
					     dataType : "json",
	...
	<body class="mainbody">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="<%=basePath%>backActivity/toActivityPage.do"><i></i><span>新增</span></a></li>
                        <li><a class="all" href="javascript:;" onclick="checkAll(this)"><i></i><span>全选</span></a></li>	                        
                    </ul>
                </div>
                <div class="r-list l-list">
					<form name="form1" method="post" action="<%=basePath%>backActivity/activityList.do" id="form1">						
					
						<ul class="icon-list" style="margin-right:0px">
			                <li><a class="xjt" href="javascript:void(0);"><span>活动标题:</span></a></li>
			            </ul>
			            <input name="name" id="name" type="text" maxlength="20" class="keyword" placeholder="请输入活动标题" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable" id="tableContent">
            <tr>
                ...
                <th align="left">海报</th>
                <th align="left">活动简介</th>
                <th align="left">联系人电话</th>
                <th align="left">所属类型</th>
                <th align="left">所属学校</th>
                <th align="left">活动时间</th>
                <th align="left">操作</th>
            </tr>
			<c:forEach items="${data.list}" var="obj">
	            <tr id="tr${obj.aid }">
	                <td align="center" class="checkall"><input type="checkbox" name="ids" value="${obj.aid }"/> </td>
	                <td>${obj.atitle }</td>
	                <td>
		                <img alt="" style="width:50px;height:50px;" src="${obj.aphoto}" />
	                </td>
	                <td>${obj.profiles }</td>
	                <td>${obj.telphone }</td>
	                <td>${obj.atname }</td>
	                ...
	                <td>${obj.atime}</td>
	                <td align="center">
		                <a href="javascript:deleteData('${obj.aid}')">删除</a>
		                <a href="<%=basePath%>backActivity/toActivityUpdatePage.do?aid=${obj.aid }" id="update">修改</a>
	        		</td>
	            </tr>
		</c:forEach>
