...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	...
	    	function deleteData(atid){
	    		if (confirm("确定要删除该数据吗？")){
	    			$.ajax({
					     url : "<%=basePath%>backActivity/aTypeDel.do",
					     data : "atid="+atid,
					     async : false,
					     type : "post",
					     dataType : "json",
	...
	<body class="mainbody">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="<%=basePath%>backActivity/activity/activityTypeCreate.do"><i></i><span>新增</span></a></li>
                        <li><a class="all" href="javascript:;" onclick="checkAll(this)"><i></i><span>全选</span></a></li>	                        
                    </ul>
                </div>
                <div class="r-list l-list">
					<form name="form1" method="post" action="<%=basePath%>backActivity/aTypeList.do" id="form1">						
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable" id="tableContent">
            <tr>
                <th width="70">选择</th>
                <th align="left">活动类型名称</th>
                <th align="left">活动图标</th>
                <th align="left">操作</th>
            </tr>
			<c:forEach items="${data.list}" var="obj">
	            <tr id="tr${obj.atid }">
	                <td align="center" class="checkall"><input type="checkbox" name="ids" value="${obj.atid }"/> </td>
	                <td>${obj.atname }</td>
	                <td>
		                <img alt="" style="width:50px;height:50px;" src="${obj.icopath}" />
	                </td>
	                <td align="center">
		                <a href="javascript:deleteData('${obj.atid}')">删除</a>
	        		</td>
	            </tr>
		</c:forEach>
