...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	...
	    	function update(){
	    		$.ajax({
				     url : "<%=basePath%>backActivity/activityUpdate.do",
	        ...
	        <div class="content-tab-wrap">
	            <div id="floatHead" class="content-tab">
	                <div class="content-tab-ul-wrap">
	                    <ul>
	                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">修改活动信息</a></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
	        ...
	        <input type="hidden" name="isPost" value="1"/>
	         <div class="tab-content">
	            <dl>
	                ...
	                <dd class="ctrl">
	                    <input name="atitle" type="text" value="${activity.atitle}" id="Atitle" class="input normal" maxlength="30"/>
	                </dd>
	                <dd class="tip">
	            ...
	            <dl>
	                ...
	                <dd class="ctrl">
	                    <input name="Telphone" type="text" value="${activity.telphone}" id="Telphone" class="input normal" maxlength="30"/>
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
	            ...
	            <dl>
	                <dt>海报:</dt>
	                <dd class="ctrl">
	                	<input type="hidden" id="icoPathHidden" name="Aphoto" value="${activity.aphoto}" />
	                    <img id="icopath" style="width:100px;height:100px;" alt="" src="${activity.aphoto}" />
	            ...
	            <dl>
	                <dt>海报2:</dt>
	                <dd class="ctrl">
	                	<input type="hidden" id="icoPathHidden2" name="Aphoto2" value="${activity.aphoto2}" />
	                    <img id="icopath2" style="width:100px;height:100px;" alt="" src="${activity.aphoto2}" />
	            ...
	            <dl>
	                <dt>海报3:</dt>
	                <dd class="ctrl">
	                	<input type="hidden" id="icoPathHidden3" name="Aphoto3" value="${activity.aphoto3}" />
	                    <img id="icopath3" style="width:100px;height:100px;" alt="" src="${activity.aphoto3}" />
				...
				<dl>
	                <dt>活动简介:</dt>
	                <dd class="ctrl">
	                    <input name="Profiles" type="text" value="${activity.profiles}" id="Profiles" class="input normal" maxlength="30"/>
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
	            ...
	            <dl>
	                <dt>活动日期:</dt>
	                <dd class="ctrl">
	                    <input name="Atime" type="text" value="${activity.atime}" id="atime" class="input normal" maxlength="30" class="Wdate" readonly  onclick="WdatePicker()"/>
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
	            ...
	            <dl>
	                ...
	                <dd class="ctrl">
	                    <input name="Aaddress" type="text" value="${activity.aaddress}" id="Aaddress" class="input normal" maxlength="30"/>
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
	            ...
	            <dl>
	                ...
	                <dd class="ctrl">
	                    <select name="atid" onchange="onchangeHidden(this, 'Atname')">
	                    	...
	                    	<c:forEach items="${activityTypeList}" var="activitytemp">
	                    	<option value="${activitytemp.atid}" opname="${activitytemp.atname}" ${activity.atid == activitytemp.atid ? 'selected="selected"':"" } >${activitytemp.atname}</option>
	                    	</c:forEach>
	                    </select>
	                    <input type="hidden" name="Atname" id="Atname" value="${activity.atname}" />
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
	            ...
	            <dl>
	                ...
	                <dd class="ctrl">
	                    <select name="sid" onchange="onchangeHidden(this, 'Sname')">
	                    	...
	                    	<option value="${school.sid}" opname="${school.sname}"  ${activity.sid == school.sid ? 'selected="selected"':"" }>${school.sname}</option>
	                    	</c:forEach>
	                    </select>
	                    <input type="hidden" name="Sname" id="Sname" value="${activity.sname}" />
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
	            ...
	            <dl>
	                <dt>活动详细介绍:</dt>
	                <dd class="ctrl">
	                    <textarea rows="10" cols="50" name="Adesc">${activity.adesc}</textarea>
	                </dd>
	                <dd class="tip">
	                	<div id="pvttitleTip"></div>       
	                </dd>
		        ...
		        <dl>
	                <dd class="btndd">
			            <div class="btn-list">
			                <input type="button" name="btnSubmit" id="btnSubmit" value="修改信息"  onclick="update()" class="btn" />
