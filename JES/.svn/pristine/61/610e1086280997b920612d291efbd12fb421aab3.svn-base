...
/**验证长度 str 要验证的字符，字符长度**/
function checklength(str, leng) {
    if (str.length > leng) {
        return false;
    }
    else
...
///**移动号码验证**/
///**134、135、136、137、138、139、147、150、151、152、157、158、159、182、188**/
//function ChinaMobile(value) {
//    /**移动号段：134-9，147，150-2，157-9，187-8**/
//    var res = /^[1](3[4-9]{1}|47|5[0-2]{1}|5[7-9]{1}|8[2-3]{1}|8[7-8]{1})\d{8}$/;
...
/**电信号码验证 添加170号段支持**/
function ChinaTelecomNew(value) {
